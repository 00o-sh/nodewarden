...
const ru: Record<string, string> = {
  ...
  "txt_err_archive_item_failed": "Не удалось архивировать элемент",
  "txt_err_attachment_decryption_failed": "Не удалось расшифровать вложение",
  "txt_err_attachment_id_is_required": "Требуется ID вложения",
  "txt_err_bulk_archive_failed": "Не удалось массово архивировать",
  "txt_err_bulk_delete_failed": "Не удалось массово удалить",
  "txt_err_bulk_delete_folders_failed": "Не удалось массово удалить папки",
  "txt_err_bulk_delete_sends_failed": "Не удалось массово удалить Send",
  "txt_err_bulk_move_failed": "Не удалось массово переместить",
  "txt_err_bulk_permanent_delete_failed": "Не удалось массово удалить безвозвратно",
  "txt_err_bulk_restore_failed": "Не удалось массово восстановить",
  "txt_err_bulk_unarchive_failed": "Не удалось массово разархивировать",
  "txt_err_cannot_export_ed25519_private_key": "Не удалось экспортировать закрытый ключ Ed25519",
  "txt_err_cannot_export_ed25519_public_key": "Не удалось экспортировать открытый ключ Ed25519",
  "txt_err_change_master_password_failed": "Не удалось изменить мастер-пароль",
  "txt_err_cipher_id_is_required": "Требуется ID элемента",
  "txt_err_create_attachment_failed": "Не удалось создать вложение",
  "txt_err_create_file_send_failed": "Не удалось создать файловый Send",
  "txt_err_create_file_send_failed_missing_upload_url": "Не удалось создать файловый Send: отсутствует URL загрузки",
  "txt_err_create_folder_failed": "Не удалось создать папку",
  "txt_err_create_invite_failed": "Не удалось создать приглашение",
  "txt_err_create_item_failed": "Не удалось создать элемент",
  "txt_err_create_send_failed": "Не удалось создать Send",
  "txt_err_current_administrator_profile_is_missing_a_priva": "В профиле текущего администратора отсутствует закрытый ключ",
  "txt_err_current_administrator_profile_is_missing_an_id": "В профиле текущего администратора отсутствует ID",
  "txt_err_current_session_is_missing_unlocked_vault_keys": "В текущем сеансе отсутствуют разблокированные ключи хранилища",
  "txt_err_delete_all_invites_failed": "Не удалось удалить все приглашения",
  "txt_err_delete_folder_failed": "Не удалось удалить папку",
  "txt_err_delete_item_failed": "Не удалось удалить элемент",
  "txt_err_delete_user_failed": "Не удалось удалить пользователя",
  "txt_err_deletion_days_is_required": "Требуется указать дни до удаления",
  "txt_err_demo_mode_is_not_available_in_this_build": "Демонстрационный режим недоступен в этой сборке.",
  "txt_err_download_attachment_failed": "Не удалось скачать вложение",
  "txt_err_email_is_required": "Требуется адрес эл. почты",
  "txt_err_encrypted_export_requires_encrypted_import_flow": "Для зашифрованного экспорта требуется поток зашифрованного импорта.",
  "txt_err_encrypted_organization_export_is_not_supported_y": "Зашифрованный экспорт организации пока не поддерживается.",
  "txt_err_failed_to_clear_audit_logs": "Не удалось очистить журналы аудита",
  "txt_err_failed_to_load_totp_status": "Не удалось загрузить статус TOTP",
  "txt_err_failed_to_load_account_passkeys": "Не удалось загрузить ключи доступа аккаунта",
  "txt_err_failed_to_load_audit_log_settings": "Не удалось загрузить настройки журнала аудита",
  "txt_err_failed_to_load_audit_logs": "Не удалось загрузить журналы аудита",
  "txt_err_failed_to_load_invites": "Не удалось загрузить приглашения",
  "txt_err_failed_to_load_profile": "Не удалось загрузить профиль",
  "txt_err_failed_to_load_revision_date": "Не удалось загрузить дату изменения",
  "txt_err_failed_to_load_sends": "Не удалось загрузить Send",
  "txt_err_failed_to_load_users": "Не удалось загрузить пользователей",
  "txt_err_failed_to_load_vault": "Не удалось загрузить хранилище",
  "txt_err_failed_to_save_audit_log_settings": "Не удалось сохранить настройки журнала аудита",
  "txt_err_file_is_required": "Требуется файл",
  "txt_err_file_password_is_required": "Требуется пароль файла",
  "txt_err_folder_id_is_required": "Требуется ID папки",
  "txt_err_invalid_bitwarden_json": "Недопустимый Bitwarden JSON",
  "txt_err_invalid_keepass_xml_structure": "Недопустимая структура KeePass XML",
  "txt_err_invalid_xml_file": "Недопустимый XML-файл",
  "txt_err_invalid_attachment_download_response": "Недопустимый ответ на скачивание вложения",
  "txt_err_invalid_attachment_name": "Недопустимое имя вложения",
  "txt_err_invalid_deletion_days": "Недопустимое число дней до удаления",
  "txt_err_invalid_encrypted_file_data": "Недопустимые зашифрованные данные файла",
  "txt_err_invalid_expiration_days": "Недопустимое число дней до истечения срока",
  "txt_err_invalid_file_name": "Недопустимое имя файла",
  "txt_err_invalid_max_access_count": "Недопустимое максимальное число обращений",
  "txt_err_invalid_passkey_assertion_options": "Недопустимые параметры аутентификации passkey",
  "txt_err_invalid_passkey_creation_options": "Недопустимые параметры создания passkey",
  "txt_err_invalid_profile": "Недопустимый профиль",
  "txt_err_invalid_profile_key": "Недопустимый ключ профиля",
  "txt_err_invalid_revision_date": "Недопустимая дата изменения",
  "txt_err_mac_mismatch": "Несовпадение MAC",
  "txt_err_missing_mac_for_authenticated_cipher": "Отсутствует MAC для аутентифицированного шифра",
  "txt_err_missing_file_url": "Отсутствует URL файла",
  "txt_err_missing_profile_key": "Отсутствует ключ профиля",
  "txt_err_no_portable_backup_settings_wrap_is_available_fo": "Для текущего администратора нет доступной обёртки настроек переносного резервного копирования",
  "txt_err_offline_unlock_is_not_available_on_this_device": "Офлайн-разблокировка недоступна на этом устройстве.",
  "txt_err_output_entropy_of_hash_function_is_too_small": "Выходная энтропия хеш-функции слишком мала",
  "txt_err_permanent_delete_item_failed": "Не удалось безвозвратно удалить элемент",
  "txt_err_revoke_invite_failed": "Не удалось отозвать приглашение",
  "txt_err_send_key_unavailable": "Ключ Send недоступен",
  "txt_err_send_text_is_required": "Требуется текст Send",
  "txt_err_unable_to_import_an_encrypted_proton_pass_export": "Не удалось импортировать зашифрованный экспорт Proton Pass.",
  "txt_err_unable_to_import_an_encrypted_passky_backup": "Не удалось импортировать зашифрованную резервную копию passky.",
  "txt_err_unarchive_item_failed": "Не удалось разархивировать элемент",
  "txt_err_unauthorized": "Не авторизовано",
  "txt_err_unsupported_file_encryption_type": "Неподдерживаемый тип шифрования файла",
  "txt_err_update_folder_failed": "Не удалось обновить папку",
  "txt_err_update_item_failed": "Не удалось обновить элемент",
  "txt_err_update_send_failed": "Не удалось обновить Send",
  "txt_err_update_user_status_failed": "Не удалось обновить статус пользователя",
  "txt_err_updating_file_content_is_not_supported_yet": "Обновление содержимого файла пока не поддерживается",
  "txt_err_vault_key_unavailable": "Ключ хранилища недоступен",
  "txt_err_invalid_encrypted_string": "Недопустимая зашифрованная строка",
  "txt_err_prelogin_failed": "Не удалось выполнить предварительный вход",
  "txt_err_unsupported_enc_type": "Неподдерживаемый тип шифрования",
  "txt_err_import_exceeds_max": "Импорт превышает максимум в {count} элементов",
  "txt_nodewarden_logo_alt": "Логотип NodeWarden",
  "txt_totp_qr_alt": "QR-код TOTP",
  "nav_email_aliases": "Псевдонимы почты",
  "txt_alias_page_title": "Псевдонимы электронной почты",
  "txt_alias_page_subtitle": "Создавайте пересылающие псевдонимы на своём домене на базе Cloudflare Email Routing.",
  "txt_alias_disabled_notice": "Генератор псевдонимов не включён на этом сервере. Попросите администратора включить его.",
  "txt_alias_disabled_admin": "Генератор псевдонимов отключён. Включите его и настройте домены в параметрах ниже.",
  "txt_alias_domain": "Домен",
  "txt_alias_format": "Формат",
  "txt_alias_format_random_chars": "Случайные символы",
  "txt_alias_format_random_words": "Случайные слова",
  "txt_alias_format_uuid": "UUID",
  "txt_alias_destination": "Пересылать на",
  "txt_alias_destination_default": "Адрес по умолчанию",
  "txt_alias_generate": "Создать псевдоним",
  "txt_alias_created_toast": "Псевдоним создан",
  "txt_alias_created_copied": "Псевдоним создан и скопирован в буфер обмена",
  "txt_alias_deleted_toast": "Псевдоним удалён",
  "txt_alias_copied": "Скопировано в буфер обмена",
  "txt_alias_your_aliases": "Ваши псевдонимы",
  "txt_alias_none": "Псевдонимов пока нет.",
  "txt_alias_active": "Активен",
  "txt_alias_inactive": "Отключён",
  "txt_alias_enable": "Включить",
  "txt_alias_disable": "Отключить",
  "txt_alias_tokens_title": "Токены доступа API",
  "txt_alias_tokens_desc": "Создайте токен для использования генератора в официальных клиентах Bitwarden.",
  "txt_alias_token_name": "Имя токена",
  "txt_alias_token_default_name": "Токен API",
  "txt_alias_token_secret_notice": "Скопируйте токен сейчас — он больше не будет показан.",
  "txt_alias_token_last_used": "Последнее использование {date}",
  "txt_alias_token_never_used": "Не использовался",
  "txt_alias_token_revoked_toast": "Токен отозван",
  "txt_alias_client_setup_title": "Использование в официальных клиентах Bitwarden",
  "txt_alias_client_setup_desc": "В генераторе псевдонимов выберите addy.io и заполните эти значения:",
  "txt_alias_setup_step_service": "Сервис: addy.io",
  "txt_alias_setup_step_url": "URL собственного сервера: {url}",
  "txt_alias_setup_step_token": "Токен доступа API: созданный выше токен",
  "txt_alias_setup_step_domain": "Домен: один из настроенных доменов псевдонимов",
  "txt_alias_settings_title": "Настройки генератора",
  "txt_alias_settings_cf_configured": "Учётные данные Cloudflare API настроены; доступны произвольные адреса и отключение псевдонимов.",
  "txt_alias_settings_cf_missing": "Учётные данные Cloudflare API не заданы. Catch-all псевдонимы работают; произвольные адреса и отключение требуют CF_API_TOKEN и CF_ZONE_ID.",
  "txt_alias_settings_enabled": "Включить генератор псевдонимов",
  "txt_alias_settings_domains": "Домены псевдонимов",
  "txt_alias_settings_domains_help": "По одному домену в строке. Для них должен быть включён Cloudflare Email Routing.",
  "txt_alias_settings_default_domain": "Домен по умолчанию",
  "txt_alias_settings_default_destination": "Адрес пересылки по умолчанию",
  "txt_alias_settings_recipients": "Разрешённые адреса",
  "txt_alias_settings_recipients_help": "По одному адресу в строке. Доступны как расширенные адреса пересылки.",
  "txt_alias_settings_saved_toast": "Настройки псевдонимов сохранены",
  "txt_alias_load_failed": "Не удалось загрузить псевдонимы",
  "txt_alias_create_failed": "Не удалось создать псевдоним",
  "txt_alias_update_failed": "Не удалось обновить псевдоним",
  "txt_alias_delete_failed": "Не удалось удалить псевдоним",
  "txt_alias_token_load_failed": "Не удалось загрузить токены",
  "txt_alias_token_create_failed": "Не удалось создать токен",
  "txt_alias_token_delete_failed": "Не удалось отозвать токен",
  "txt_alias_settings_load_failed": "Не удалось загрузить настройки псевдонимов",
  "txt_alias_settings_save_failed": "Не удалось сохранить настройки псевдонимов",
};
