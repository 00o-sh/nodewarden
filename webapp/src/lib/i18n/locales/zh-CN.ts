...
const zhCN: Record<string, string> = {
  ...
  "txt_backup_recommend_koofr_storage_link": "存储",
  ...
  "txt_delete_selected_items_permanently": "永久删除所选项目",
  ...
  "txt_err_archive_item_failed": "归档项目失败",
  "txt_err_attachment_decryption_failed": "附件解密失败",
  "txt_err_attachment_id_is_required": "附件 ID 不能为空",
  "txt_err_bulk_archive_failed": "批量归档失败",
  "txt_err_bulk_delete_failed": "批量删除失败",
  "txt_err_bulk_delete_folders_failed": "批量删除文件夹失败",
  "txt_err_bulk_delete_sends_failed": "批量删除 Send 失败",
  "txt_err_bulk_move_failed": "批量移动失败",
  "txt_err_bulk_permanent_delete_failed": "批量永久删除失败",
  "txt_err_bulk_restore_failed": "批量恢复失败",
  "txt_err_bulk_unarchive_failed": "批量取消归档失败",
  "txt_err_cannot_export_ed25519_private_key": "无法导出 Ed25519 私钥",
  "txt_err_cannot_export_ed25519_public_key": "无法导出 Ed25519 公钥",
  "txt_err_change_master_password_failed": "修改主密码失败",
  "txt_err_cipher_id_is_required": "密码项 ID 不能为空",
  "txt_err_create_attachment_failed": "创建附件失败",
  "txt_err_create_file_send_failed": "创建文件 Send 失败",
  "txt_err_create_file_send_failed_missing_upload_url": "创建文件 Send 失败：缺少上传地址",
  "txt_err_create_folder_failed": "创建文件夹失败",
  "txt_err_create_invite_failed": "创建邀请失败",
  "txt_err_create_item_failed": "创建项目失败",
  "txt_err_create_send_failed": "创建 Send 失败",
  "txt_err_current_administrator_profile_is_missing_a_priva": "当前管理员资料缺少私钥",
  "txt_err_current_administrator_profile_is_missing_an_id": "当前管理员资料缺少 ID",
  "txt_err_current_session_is_missing_unlocked_vault_keys": "当前会话缺少已解锁的密码库密钥",
  "txt_err_delete_all_invites_failed": "删除所有邀请失败",
  "txt_err_delete_folder_failed": "删除文件夹失败",
  "txt_err_delete_item_failed": "删除项目失败",
  "txt_err_delete_user_failed": "删除用户失败",
  "txt_err_deletion_days_is_required": "删除天数不能为空",
  "txt_err_demo_mode_is_not_available_in_this_build": "此版本不支持演示模式。",
  "txt_err_download_attachment_failed": "下载附件失败",
  "txt_err_email_is_required": "邮箱不能为空",
  "txt_err_encrypted_export_requires_encrypted_import_flow": "加密导出需使用加密导入流程。",
  "txt_err_encrypted_organization_export_is_not_supported_y": "暂不支持加密的组织导出。",
  "txt_err_failed_to_clear_audit_logs": "清除审计日志失败",
  "txt_err_failed_to_load_totp_status": "加载 TOTP 状态失败",
  "txt_err_failed_to_load_account_passkeys": "加载账户通行密钥失败",
  "txt_err_failed_to_load_audit_log_settings": "加载审计日志设置失败",
  "txt_err_failed_to_load_audit_logs": "加载审计日志失败",
  "txt_err_failed_to_load_invites": "加载邀请失败",
  "txt_err_failed_to_load_profile": "加载资料失败",
  "txt_err_failed_to_load_revision_date": "加载修订日期失败",
  "txt_err_failed_to_load_sends": "加载 Send 失败",
  "txt_err_failed_to_load_users": "加载用户失败",
  "txt_err_failed_to_load_vault": "加载密码库失败",
  "txt_err_failed_to_save_audit_log_settings": "保存审计日志设置失败",
  "txt_err_file_is_required": "文件不能为空",
  "txt_err_file_password_is_required": "文件密码不能为空",
  "txt_err_folder_id_is_required": "文件夹 ID 不能为空",
  "txt_err_invalid_bitwarden_json": "无效的 Bitwarden JSON",
  "txt_err_invalid_keepass_xml_structure": "无效的 KeePass XML 结构",
  "txt_err_invalid_xml_file": "无效的 XML 文件",
  "txt_err_invalid_attachment_download_response": "无效的附件下载响应",
  "txt_err_invalid_attachment_name": "无效的附件名称",
  "txt_err_invalid_deletion_days": "无效的删除天数",
  "txt_err_invalid_encrypted_file_data": "无效的加密文件数据",
  "txt_err_invalid_expiration_days": "无效的过期天数",
  "txt_err_invalid_file_name": "无效的文件名",
  "txt_err_invalid_max_access_count": "无效的最大访问次数",
  "txt_err_invalid_passkey_assertion_options": "无效的通行密钥断言选项",
  "txt_err_invalid_passkey_creation_options": "无效的通行密钥创建选项",
  "txt_err_invalid_profile": "无效的资料",
  "txt_err_invalid_profile_key": "无效的资料密钥",
  "txt_err_invalid_revision_date": "无效的修订日期",
  "txt_err_mac_mismatch": "MAC 校验不匹配",
  "txt_err_missing_mac_for_authenticated_cipher": "认证密文缺少 MAC",
  "txt_err_missing_file_url": "缺少文件地址",
  "txt_err_missing_profile_key": "缺少资料密钥",
  "txt_err_no_portable_backup_settings_wrap_is_available_fo": "当前管理员没有可用的便携备份设置封装",
  "txt_err_offline_unlock_is_not_available_on_this_device": "此设备不支持离线解锁。",
  "txt_err_output_entropy_of_hash_function_is_too_small": "哈希函数的输出熵过小",
  "txt_err_permanent_delete_item_failed": "永久删除项目失败",
  "txt_err_revoke_invite_failed": "撤销邀请失败",
  "txt_err_send_key_unavailable": "Send 密钥不可用",
  "txt_err_send_text_is_required": "Send 文本不能为空",
  "txt_err_unable_to_import_an_encrypted_proton_pass_export": "无法导入加密的 Proton Pass 导出文件。",
  "txt_err_unable_to_import_an_encrypted_passky_backup": "无法导入加密的 passky 备份。",
  "txt_err_unarchive_item_failed": "取消归档项目失败",
  "txt_err_unauthorized": "未授权",
  "txt_err_unsupported_file_encryption_type": "不支持的文件加密类型",
  "txt_err_update_folder_failed": "更新文件夹失败",
  "txt_err_update_item_failed": "更新项目失败",
  "txt_err_update_send_failed": "更新 Send 失败",
  "txt_err_update_user_status_failed": "更新用户状态失败",
  "txt_err_updating_file_content_is_not_supported_yet": "暂不支持更新文件内容",
  "txt_err_vault_key_unavailable": "密码库密钥不可用",
  "txt_err_invalid_encrypted_string": "无效的加密字符串",
  "txt_err_prelogin_failed": "预登录失败",
  "txt_err_unsupported_enc_type": "不支持的加密类型",
  "txt_err_import_exceeds_max": "导入超过最大 {count} 条限制",
  "txt_nodewarden_logo_alt": "NodeWarden 标志",
  "txt_totp_qr_alt": "TOTP 二维码",
  "nav_email_aliases": "邮箱别名",
  "txt_alias_page_title": "邮箱别名",
  "txt_alias_page_subtitle": "在你自己的域名上生成转发邮箱别名，底层由 Cloudflare Email Routing 提供。",
  "txt_alias_disabled_notice": "本服务器未启用邮箱别名生成器，请联系管理员启用。",
  "txt_alias_disabled_admin": "邮箱别名生成器已禁用。请在下方设置中启用并配置域名。",
  "txt_alias_domain": "域名",
  "txt_alias_format": "格式",
  "txt_alias_format_random_chars": "随机字符",
  "txt_alias_format_random_words": "随机单词",
  "txt_alias_format_uuid": "UUID",
  "txt_alias_destination": "转发至",
  "txt_alias_destination_default": "默认目标地址",
  "txt_alias_generate": "生成别名",
  "txt_alias_created_toast": "别名已创建",
  "txt_alias_created_copied": "别名已创建并复制到剪贴板",
  "txt_alias_deleted_toast": "别名已删除",
  "txt_alias_copied": "已复制到剪贴板",
  "txt_alias_your_aliases": "你的别名",
  "txt_alias_none": "暂无别名。",
  "txt_alias_active": "已启用",
  "txt_alias_inactive": "已禁用",
  "txt_alias_enable": "启用",
  "txt_alias_disable": "禁用",
  "txt_alias_tokens_title": "API 访问令牌",
  "txt_alias_tokens_desc": "创建令牌以便在官方 Bitwarden 客户端中使用别名生成器。",
  "txt_alias_token_name": "令牌名称",
  "txt_alias_token_default_name": "API 令牌",
  "txt_alias_token_secret_notice": "请立即复制此令牌，它不会再次显示。",
  "txt_alias_token_last_used": "上次使用 {date}",
  "txt_alias_token_never_used": "从未使用",
  "txt_alias_token_revoked_toast": "令牌已吊销",
  "txt_alias_client_setup_title": "在官方 Bitwarden 客户端中使用",
  "txt_alias_client_setup_desc": "在“转发邮箱别名”生成器中选择 addy.io 并填写以下内容：",
  "txt_alias_setup_step_service": "服务：addy.io",
  "txt_alias_setup_step_url": "自托管服务器地址：{url}",
  "txt_alias_setup_step_token": "API 访问令牌：上面创建的令牌",
  "txt_alias_setup_step_domain": "域名：已配置的别名域名之一",
  "txt_alias_settings_title": "生成器设置",
  "txt_alias_settings_cf_configured": "已配置 Cloudflare API 凭据；可使用自定义转发目标并停用别名。",
  "txt_alias_settings_cf_missing": "未设置 Cloudflare API 凭据。Catch-all 别名可用；自定义目标与停用需要 CF_API_TOKEN 和 CF_ZONE_ID。",
  "txt_alias_settings_enabled": "启用别名生成器",
  "txt_alias_settings_domains": "别名域名",
  "txt_alias_settings_domains_help": "每行一个域名，且必须已启用 Cloudflare Email Routing。",
  "txt_alias_settings_default_domain": "默认域名",
  "txt_alias_settings_default_destination": "默认转发目标地址",
  "txt_alias_settings_recipients": "允许的目标地址",
  "txt_alias_settings_recipients_help": "每行一个邮箱，可作为高级转发目标供选择。",
  "txt_alias_settings_saved_toast": "别名设置已保存",
  "txt_alias_load_failed": "加载别名失败",
  "txt_alias_create_failed": "创建别名失败",
  "txt_alias_update_failed": "更新别名失败",
  "txt_alias_delete_failed": "删除别名失败",
  "txt_alias_token_load_failed": "加载令牌失败",
  "txt_alias_token_create_failed": "创建令牌失败",
  "txt_alias_token_delete_failed": "吊销令牌失败",
  "txt_alias_settings_load_failed": "加载别名设置失败",
  "txt_alias_settings_save_failed": "保存别名设置失败",
};
