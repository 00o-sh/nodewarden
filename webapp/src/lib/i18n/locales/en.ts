...
const en: Record<string, string> = {
  ...
  "txt_err_archive_item_failed": "Archive item failed",
  "txt_err_attachment_decryption_failed": "Attachment decryption failed",
  "txt_err_attachment_id_is_required": "Attachment id is required",
  "txt_err_bulk_archive_failed": "Bulk archive failed",
  "txt_err_bulk_delete_failed": "Bulk delete failed",
  "txt_err_bulk_delete_folders_failed": "Bulk delete folders failed",
  "txt_err_bulk_delete_sends_failed": "Bulk delete sends failed",
  "txt_err_bulk_move_failed": "Bulk move failed",
  "txt_err_bulk_permanent_delete_failed": "Bulk permanent delete failed",
  "txt_err_bulk_restore_failed": "Bulk restore failed",
  "txt_err_bulk_unarchive_failed": "Bulk unarchive failed",
  "txt_err_cannot_export_ed25519_private_key": "Cannot export Ed25519 private key",
  "txt_err_cannot_export_ed25519_public_key": "Cannot export Ed25519 public key",
  "txt_err_change_master_password_failed": "Change master password failed",
  "txt_err_cipher_id_is_required": "Cipher id is required",
  "txt_err_create_attachment_failed": "Create attachment failed",
  "txt_err_create_file_send_failed": "Create file send failed",
  "txt_err_create_file_send_failed_missing_upload_url": "Create file send failed: missing upload URL",
  "txt_err_create_folder_failed": "Create folder failed",
  "txt_err_create_invite_failed": "Create invite failed",
  "txt_err_create_item_failed": "Create item failed",
  "txt_err_create_send_failed": "Create send failed",
  "txt_err_current_administrator_profile_is_missing_a_priva": "Current administrator profile is missing a private key",
  "txt_err_current_administrator_profile_is_missing_an_id": "Current administrator profile is missing an id",
  "txt_err_current_session_is_missing_unlocked_vault_keys": "Current session is missing unlocked vault keys",
  "txt_err_delete_all_invites_failed": "Delete all invites failed",
  "txt_err_delete_folder_failed": "Delete folder failed",
  "txt_err_delete_item_failed": "Delete item failed",
  "txt_err_delete_user_failed": "Delete user failed",
  "txt_err_deletion_days_is_required": "Deletion days is required",
  "txt_err_demo_mode_is_not_available_in_this_build": "Demo mode is not available in this build.",
  "txt_err_download_attachment_failed": "Download attachment failed",
  "txt_err_email_is_required": "Email is required",
  "txt_err_encrypted_export_requires_encrypted_import_flow": "Encrypted export requires encrypted import flow.",
  "txt_err_encrypted_organization_export_is_not_supported_y": "Encrypted organization export is not supported yet.",
  "txt_err_failed_to_clear_audit_logs": "Failed to clear audit logs",
  "txt_err_failed_to_load_totp_status": "Failed to load TOTP status",
  "txt_err_failed_to_load_account_passkeys": "Failed to load account passkeys",
  "txt_err_failed_to_load_audit_log_settings": "Failed to load audit log settings",
  "txt_err_failed_to_load_audit_logs": "Failed to load audit logs",
  "txt_err_failed_to_load_invites": "Failed to load invites",
  "txt_err_failed_to_load_profile": "Failed to load profile",
  "txt_err_failed_to_load_revision_date": "Failed to load revision date",
  "txt_err_failed_to_load_sends": "Failed to load sends",
  "txt_err_failed_to_load_users": "Failed to load users",
  "txt_err_failed_to_load_vault": "Failed to load vault",
  "txt_err_failed_to_save_audit_log_settings": "Failed to save audit log settings",
  "txt_err_file_is_required": "File is required",
  "txt_err_file_password_is_required": "File password is required",
  "txt_err_folder_id_is_required": "Folder id is required",
  "txt_err_invalid_bitwarden_json": "Invalid Bitwarden JSON",
  "txt_err_invalid_keepass_xml_structure": "Invalid KeePass XML structure",
  "txt_err_invalid_xml_file": "Invalid XML file",
  "txt_err_invalid_attachment_download_response": "Invalid attachment download response",
  "txt_err_invalid_attachment_name": "Invalid attachment name",
  "txt_err_invalid_deletion_days": "Invalid deletion days",
  "txt_err_invalid_encrypted_file_data": "Invalid encrypted file data",
  "txt_err_invalid_expiration_days": "Invalid expiration days",
  "txt_err_invalid_file_name": "Invalid file name",
  "txt_err_invalid_max_access_count": "Invalid max access count",
  "txt_err_invalid_passkey_assertion_options": "Invalid passkey assertion options",
  "txt_err_invalid_passkey_creation_options": "Invalid passkey creation options",
  "txt_err_invalid_profile": "Invalid profile",
  "txt_err_invalid_profile_key": "Invalid profile key",
  "txt_err_invalid_revision_date": "Invalid revision date",
  "txt_err_mac_mismatch": "MAC mismatch",
  "txt_err_missing_mac_for_authenticated_cipher": "Missing MAC for authenticated cipher",
  "txt_err_missing_file_url": "Missing file URL",
  "txt_err_missing_profile_key": "Missing profile key",
  "txt_err_no_portable_backup_settings_wrap_is_available_fo": "No portable backup settings wrap is available for the current administrator",
  "txt_err_offline_unlock_is_not_available_on_this_device": "Offline unlock is not available on this device.",
  "txt_err_output_entropy_of_hash_function_is_too_small": "Output entropy of hash function is too small",
  "txt_err_permanent_delete_item_failed": "Permanent delete item failed",
  "txt_err_revoke_invite_failed": "Revoke invite failed",
  "txt_err_send_key_unavailable": "Send key unavailable",
  "txt_err_send_text_is_required": "Send text is required",
  "txt_err_unable_to_import_an_encrypted_proton_pass_export": "Unable to import an encrypted Proton Pass export.",
  "txt_err_unable_to_import_an_encrypted_passky_backup": "Unable to import an encrypted passky backup.",
  "txt_err_unarchive_item_failed": "Unarchive item failed",
  "txt_err_unauthorized": "Unauthorized",
  "txt_err_unsupported_file_encryption_type": "Unsupported file encryption type",
  "txt_err_update_folder_failed": "Update folder failed",
  "txt_err_update_item_failed": "Update item failed",
  "txt_err_update_send_failed": "Update send failed",
  "txt_err_update_user_status_failed": "Update user status failed",
  "txt_err_updating_file_content_is_not_supported_yet": "Updating file content is not supported yet",
  "txt_err_vault_key_unavailable": "Vault key unavailable",
  "txt_err_invalid_encrypted_string": "invalid encrypted string",
  "txt_err_prelogin_failed": "prelogin failed",
  "txt_err_unsupported_enc_type": "unsupported enc type",
  "txt_err_import_exceeds_max": "Import exceeds maximum of {count} items",
  "txt_nodewarden_logo_alt": "NodeWarden logo",
  "txt_totp_qr_alt": "TOTP QR code",
  "nav_email_aliases": "Email Aliases",
  "txt_alias_page_title": "Email Aliases",
  "txt_alias_page_subtitle": "Generate forwarding email aliases on your own domain, backed by Cloudflare Email Routing.",
  "txt_alias_disabled_notice": "The email alias generator is not enabled on this server. Ask an administrator to enable it.",
  "txt_alias_disabled_admin": "The email alias generator is disabled. Enable it and configure domains in the settings below.",
  "txt_alias_domain": "Domain",
  "txt_alias_format": "Format",
  "txt_alias_format_random_chars": "Random characters",
  "txt_alias_format_random_words": "Random words",
  "txt_alias_format_uuid": "UUID",
  "txt_alias_destination": "Forward to",
  "txt_alias_destination_default": "Default destination",
  "txt_alias_generate": "Generate alias",
  "txt_alias_created_toast": "Alias created",
  "txt_alias_created_copied": "Alias created and copied to clipboard",
  "txt_alias_deleted_toast": "Alias deleted",
  "txt_alias_copied": "Copied to clipboard",
  "txt_alias_your_aliases": "Your aliases",
  "txt_alias_none": "No aliases yet.",
  "txt_alias_active": "Active",
  "txt_alias_inactive": "Disabled",
  "txt_alias_enable": "Enable",
  "txt_alias_disable": "Disable",
  "txt_alias_tokens_title": "API access tokens",
  "txt_alias_tokens_desc": "Create a token to use the alias generator from the official Bitwarden clients.",
  "txt_alias_token_name": "Token name",
  "txt_alias_token_default_name": "API token",
  "txt_alias_token_secret_notice": "Copy this token now — it will not be shown again.",
  "txt_alias_token_last_used": "Last used {date}",
  "txt_alias_token_never_used": "Never used",
  "txt_alias_token_revoked_toast": "Token revoked",
  "txt_alias_client_setup_title": "Use with official Bitwarden clients",
  "txt_alias_client_setup_desc": "In the Forwarded email alias generator, choose addy.io and fill in these values:",
  "txt_alias_setup_step_service": "Service: addy.io",
  "txt_alias_setup_step_url": "Self-hosted server URL: {url}",
  "txt_alias_setup_step_token": "API access token: a token created above",
  "txt_alias_setup_step_domain": "Domain: one of the configured alias domains",
  "txt_alias_settings_title": "Generator settings",
  "txt_alias_settings_cf_configured": "Cloudflare API credentials are configured; custom destinations and disabling aliases are available.",
  "txt_alias_settings_cf_missing": "Cloudflare API credentials are not set. Catch-all aliases work; custom destinations and disabling require CF_API_TOKEN and CF_ZONE_ID.",
  "txt_alias_settings_enabled": "Enable the alias generator",
  "txt_alias_settings_domains": "Alias domains",
  "txt_alias_settings_domains_help": "One domain per line. These must have Cloudflare Email Routing enabled.",
  "txt_alias_settings_default_domain": "Default domain",
  "txt_alias_settings_default_destination": "Default forwarding destination",
  "txt_alias_settings_recipients": "Allowed destinations",
  "txt_alias_settings_recipients_help": "One email per line. Selectable as advanced forwarding destinations.",
  "txt_alias_settings_saved_toast": "Alias settings saved",
  "txt_alias_load_failed": "Failed to load aliases",
  "txt_alias_create_failed": "Failed to create alias",
  "txt_alias_update_failed": "Failed to update alias",
  "txt_alias_delete_failed": "Failed to delete alias",
  "txt_alias_token_load_failed": "Failed to load tokens",
  "txt_alias_token_create_failed": "Failed to create token",
  "txt_alias_token_delete_failed": "Failed to revoke token",
  "txt_alias_settings_load_failed": "Failed to load alias settings",
  "txt_alias_settings_save_failed": "Failed to save alias settings",
};
