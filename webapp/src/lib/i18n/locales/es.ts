...
const es: Record<string, string> = {
  ...
  "txt_close": "Cerrar",
  "txt_close_notification": "Cerrar notificación",
  "txt_total": "Total",
  ...
  "txt_err_archive_item_failed": "Error al archivar el elemento",
  "txt_err_attachment_decryption_failed": "Error al descifrar el adjunto",
  "txt_err_attachment_id_is_required": "Se requiere el ID del adjunto",
  "txt_err_bulk_archive_failed": "Error al archivar en lote",
  "txt_err_bulk_delete_failed": "Error al eliminar en lote",
  "txt_err_bulk_delete_folders_failed": "Error al eliminar carpetas en lote",
  "txt_err_bulk_delete_sends_failed": "Error al eliminar Send en lote",
  "txt_err_bulk_move_failed": "Error al mover en lote",
  "txt_err_bulk_permanent_delete_failed": "Error al eliminar permanentemente en lote",
  "txt_err_bulk_restore_failed": "Error al restaurar en lote",
  "txt_err_bulk_unarchive_failed": "Error al desarchivar en lote",
  "txt_err_cannot_export_ed25519_private_key": "No se puede exportar la clave privada Ed25519",
  "txt_err_cannot_export_ed25519_public_key": "No se puede exportar la clave pública Ed25519",
  "txt_err_change_master_password_failed": "Error al cambiar la contraseña maestra",
  "txt_err_cipher_id_is_required": "Se requiere el ID del elemento",
  "txt_err_create_attachment_failed": "Error al crear el adjunto",
  "txt_err_create_file_send_failed": "Error al crear el Send de archivo",
  "txt_err_create_file_send_failed_missing_upload_url": "Error al crear el Send de archivo: falta la URL de carga",
  "txt_err_create_folder_failed": "Error al crear la carpeta",
  "txt_err_create_invite_failed": "Error al crear la invitación",
  "txt_err_create_item_failed": "Error al crear el elemento",
  "txt_err_create_send_failed": "Error al crear el Send",
  "txt_err_current_administrator_profile_is_missing_a_priva": "Al perfil del administrador actual le falta una clave privada",
  "txt_err_current_administrator_profile_is_missing_an_id": "Al perfil del administrador actual le falta un ID",
  "txt_err_current_session_is_missing_unlocked_vault_keys": "A la sesión actual le faltan las claves desbloqueadas del almacén",
  "txt_err_delete_all_invites_failed": "Error al eliminar todas las invitaciones",
  "txt_err_delete_folder_failed": "Error al eliminar la carpeta",
  "txt_err_delete_item_failed": "Error al eliminar el elemento",
  "txt_err_delete_user_failed": "Error al eliminar el usuario",
  "txt_err_deletion_days_is_required": "Se requieren los días de eliminación",
  "txt_err_demo_mode_is_not_available_in_this_build": "El modo de demostración no está disponible en esta compilación.",
  "txt_err_download_attachment_failed": "Error al descargar el adjunto",
  "txt_err_email_is_required": "Se requiere el correo electrónico",
  "txt_err_encrypted_export_requires_encrypted_import_flow": "La exportación cifrada requiere el flujo de importación cifrada.",
  "txt_err_encrypted_organization_export_is_not_supported_y": "La exportación cifrada de la organización aún no es compatible.",
  "txt_err_failed_to_clear_audit_logs": "Error al borrar los registros de auditoría",
  "txt_err_failed_to_load_totp_status": "Error al cargar el estado de TOTP",
  "txt_err_failed_to_load_account_passkeys": "Error al cargar las llaves de acceso de la cuenta",
  "txt_err_failed_to_load_audit_log_settings": "Error al cargar la configuración del registro de auditoría",
  "txt_err_failed_to_load_audit_logs": "Error al cargar los registros de auditoría",
  "txt_err_failed_to_load_invites": "Error al cargar las invitaciones",
  "txt_err_failed_to_load_profile": "Error al cargar el perfil",
  "txt_err_failed_to_load_revision_date": "Error al cargar la fecha de revisión",
  "txt_err_failed_to_load_sends": "Error al cargar los Send",
  "txt_err_failed_to_load_users": "Error al cargar los usuarios",
  "txt_err_failed_to_load_vault": "Error al cargar el almacén",
  "txt_err_failed_to_save_audit_log_settings": "Error al guardar la configuración del registro de auditoría",
  "txt_err_file_is_required": "Se requiere el archivo",
  "txt_err_file_password_is_required": "Se requiere la contraseña del archivo",
  "txt_err_folder_id_is_required": "Se requiere el ID de la carpeta",
  "txt_err_invalid_bitwarden_json": "JSON de Bitwarden no válido",
  "txt_err_invalid_keepass_xml_structure": "Estructura XML de KeePass no válida",
  "txt_err_invalid_xml_file": "Archivo XML no válido",
  "txt_err_invalid_attachment_download_response": "Respuesta de descarga de adjunto no válida",
  "txt_err_invalid_attachment_name": "Nombre de adjunto no válido",
  "txt_err_invalid_deletion_days": "Días de eliminación no válidos",
  "txt_err_invalid_encrypted_file_data": "Datos de archivo cifrado no válidos",
  "txt_err_invalid_expiration_days": "Días de expiración no válidos",
  "txt_err_invalid_file_name": "Nombre de archivo no válido",
  "txt_err_invalid_max_access_count": "Número máximo de accesos no válido",
  "txt_err_invalid_passkey_assertion_options": "Opciones de aserción de passkey no válidas",
  "txt_err_invalid_passkey_creation_options": "Opciones de creación de passkey no válidas",
  "txt_err_invalid_profile": "Perfil no válido",
  "txt_err_invalid_profile_key": "Clave de perfil no válida",
  "txt_err_invalid_revision_date": "Fecha de revisión no válida",
  "txt_err_mac_mismatch": "Discrepancia de MAC",
  "txt_err_missing_mac_for_authenticated_cipher": "Falta el MAC del cifrado autenticado",
  "txt_err_missing_file_url": "Falta la URL del archivo",
  "txt_err_missing_profile_key": "Falta la clave de perfil",
  "txt_err_no_portable_backup_settings_wrap_is_available_fo": "No hay una envoltura de configuración de copia de seguridad portátil disponible para el administrador actual",
  "txt_err_offline_unlock_is_not_available_on_this_device": "El desbloqueo sin conexión no está disponible en este dispositivo.",
  "txt_err_output_entropy_of_hash_function_is_too_small": "La entropía de salida de la función hash es demasiado pequeña",
  "txt_err_permanent_delete_item_failed": "Error al eliminar permanentemente el elemento",
  "txt_err_revoke_invite_failed": "Error al revocar la invitación",
  "txt_err_send_key_unavailable": "Clave de Send no disponible",
  "txt_err_send_text_is_required": "Se requiere el texto del Send",
  "txt_err_unable_to_import_an_encrypted_proton_pass_export": "No se puede importar una exportación cifrada de Proton Pass.",
  "txt_err_unable_to_import_an_encrypted_passky_backup": "No se puede importar una copia de seguridad cifrada de passky.",
  "txt_err_unarchive_item_failed": "Error al desarchivar el elemento",
  "txt_err_unauthorized": "No autorizado",
  "txt_err_unsupported_file_encryption_type": "Tipo de cifrado de archivo no compatible",
  "txt_err_update_folder_failed": "Error al actualizar la carpeta",
  "txt_err_update_item_failed": "Error al actualizar el elemento",
  "txt_err_update_send_failed": "Error al actualizar el Send",
  "txt_err_update_user_status_failed": "Error al actualizar el estado del usuario",
  "txt_err_updating_file_content_is_not_supported_yet": "La actualización del contenido del archivo aún no es compatible",
  "txt_err_vault_key_unavailable": "Clave del almacén no disponible",
  "txt_err_invalid_encrypted_string": "Cadena cifrada no válida",
  "txt_err_prelogin_failed": "Error en el inicio de sesión previo",
  "txt_err_unsupported_enc_type": "Tipo de cifrado no compatible",
  "txt_err_import_exceeds_max": "La importación supera el máximo de {count} elementos",
  "txt_nodewarden_logo_alt": "Logotipo de NodeWarden",
  "txt_totp_qr_alt": "Código QR de TOTP",
  "nav_email_aliases": "Alias de correo",
  "txt_alias_page_title": "Alias de correo",
  "txt_alias_page_subtitle": "Genera alias de reenvío en tu propio dominio, con tecnología de Cloudflare Email Routing.",
  "txt_alias_disabled_notice": "El generador de alias no está habilitado en este servidor. Pide a un administrador que lo active.",
  "txt_alias_disabled_admin": "El generador de alias está deshabilitado. Actívalo y configura los dominios en los ajustes de abajo.",
  "txt_alias_domain": "Dominio",
  "txt_alias_format": "Formato",
  "txt_alias_format_random_chars": "Caracteres aleatorios",
  "txt_alias_format_random_words": "Palabras aleatorias",
  "txt_alias_format_uuid": "UUID",
  "txt_alias_destination": "Reenviar a",
  "txt_alias_destination_default": "Destino predeterminado",
  "txt_alias_generate": "Generar alias",
  "txt_alias_created_toast": "Alias creado",
  "txt_alias_created_copied": "Alias creado y copiado al portapapeles",
  "txt_alias_deleted_toast": "Alias eliminado",
  "txt_alias_copied": "Copiado al portapapeles",
  "txt_alias_your_aliases": "Tus alias",
  "txt_alias_none": "Aún no hay alias.",
  "txt_alias_active": "Activo",
  "txt_alias_inactive": "Deshabilitado",
  "txt_alias_enable": "Habilitar",
  "txt_alias_disable": "Deshabilitar",
  "txt_alias_tokens_title": "Tokens de acceso API",
  "txt_alias_tokens_desc": "Crea un token para usar el generador de alias desde los clientes oficiales de Bitwarden.",
  "txt_alias_token_name": "Nombre del token",
  "txt_alias_token_default_name": "Token de API",
  "txt_alias_token_secret_notice": "Copia este token ahora: no se volverá a mostrar.",
  "txt_alias_token_last_used": "Último uso {date}",
  "txt_alias_token_never_used": "Nunca usado",
  "txt_alias_token_revoked_toast": "Token revocado",
  "txt_alias_client_setup_title": "Usar con los clientes oficiales de Bitwarden",
  "txt_alias_client_setup_desc": "En el generador de alias de correo reenviado, elige addy.io y rellena estos valores:",
  "txt_alias_setup_step_service": "Servicio: addy.io",
  "txt_alias_setup_step_url": "URL del servidor autoalojado: {url}",
  "txt_alias_setup_step_token": "Token de acceso API: un token creado arriba",
  "txt_alias_setup_step_domain": "Dominio: uno de los dominios de alias configurados",
  "txt_alias_settings_title": "Ajustes del generador",
  "txt_alias_settings_cf_configured": "Las credenciales de la API de Cloudflare están configuradas; los destinos personalizados y la desactivación de alias están disponibles.",
  "txt_alias_settings_cf_missing": "Las credenciales de la API de Cloudflare no están configuradas. Los alias catch-all funcionan; los destinos personalizados y la desactivación requieren CF_API_TOKEN y CF_ZONE_ID.",
  "txt_alias_settings_enabled": "Habilitar el generador de alias",
  "txt_alias_settings_domains": "Dominios de alias",
  "txt_alias_settings_domains_help": "Un dominio por línea. Deben tener habilitado Cloudflare Email Routing.",
  "txt_alias_settings_default_domain": "Dominio predeterminado",
  "txt_alias_settings_default_destination": "Destino de reenvío predeterminado",
  "txt_alias_settings_recipients": "Destinos permitidos",
  "txt_alias_settings_recipients_help": "Un correo por línea. Seleccionables como destinos de reenvío avanzados.",
  "txt_alias_settings_saved_toast": "Ajustes de alias guardados",
  "txt_alias_load_failed": "No se pudieron cargar los alias",
  "txt_alias_create_failed": "No se pudo crear el alias",
  "txt_alias_update_failed": "No se pudo actualizar el alias",
  "txt_alias_delete_failed": "No se pudo eliminar el alias",
  "txt_alias_token_load_failed": "No se pudieron cargar los tokens",
  "txt_alias_token_create_failed": "No se pudo crear el token",
  "txt_alias_token_delete_failed": "No se pudo revocar el token",
  "txt_alias_settings_load_failed": "No se pudieron cargar los ajustes de alias",
  "txt_alias_settings_save_failed": "No se pudieron guardar los ajustes de alias",
};
