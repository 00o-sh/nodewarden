...
const zhTW: Record<string, string> = {
  ...
  "txt_backup_recommend_koofr_storage_link": "儲存",
  ...
  "txt_delete_selected_items_permanently": "永久刪除所選項目",
  ...
  "txt_err_archive_item_failed": "歸檔項目失敗",
  "txt_err_attachment_decryption_failed": "附件解密失敗",
  "txt_err_attachment_id_is_required": "附件 ID 不能為空",
  "txt_err_bulk_archive_failed": "批量歸檔失敗",
  "txt_err_bulk_delete_failed": "批量刪除失敗",
  "txt_err_bulk_delete_folders_failed": "批量刪除資料夾失敗",
  "txt_err_bulk_delete_sends_failed": "批量刪除 Send 失敗",
  "txt_err_bulk_move_failed": "批量移動失敗",
  "txt_err_bulk_permanent_delete_failed": "批量永久刪除失敗",
  "txt_err_bulk_restore_failed": "批量還原失敗",
  "txt_err_bulk_unarchive_failed": "批量取消歸檔失敗",
  "txt_err_cannot_export_ed25519_private_key": "無法匯出 Ed25519 私鑰",
  "txt_err_cannot_export_ed25519_public_key": "無法匯出 Ed25519 公鑰",
  "txt_err_change_master_password_failed": "修改主密碼失敗",
  "txt_err_cipher_id_is_required": "密碼項 ID 不能為空",
  "txt_err_create_attachment_failed": "建立附件失敗",
  "txt_err_create_file_send_failed": "建立檔案 Send 失敗",
  "txt_err_create_file_send_failed_missing_upload_url": "建立檔案 Send 失敗：缺少上傳網址",
  "txt_err_create_folder_failed": "建立資料夾失敗",
  "txt_err_create_invite_failed": "建立邀請失敗",
  "txt_err_create_item_failed": "建立項目失敗",
  "txt_err_create_send_failed": "建立 Send 失敗",
  "txt_err_current_administrator_profile_is_missing_a_priva": "目前管理員資料缺少私鑰",
  "txt_err_current_administrator_profile_is_missing_an_id": "目前管理員資料缺少 ID",
  "txt_err_current_session_is_missing_unlocked_vault_keys": "目前工作階段缺少已解鎖的密碼庫金鑰",
  "txt_err_delete_all_invites_failed": "刪除所有邀請失敗",
  "txt_err_delete_folder_failed": "刪除資料夾失敗",
  "txt_err_delete_item_failed": "刪除項目失敗",
  "txt_err_delete_user_failed": "刪除使用者失敗",
  "txt_err_deletion_days_is_required": "刪除天數不能為空",
  "txt_err_demo_mode_is_not_available_in_this_build": "此版本不支援示範模式。",
  "txt_err_download_attachment_failed": "下載附件失敗",
  "txt_err_email_is_required": "電子郵件不能為空",
  "txt_err_encrypted_export_requires_encrypted_import_flow": "加密匯出需使用加密匯入流程。",
  "txt_err_encrypted_organization_export_is_not_supported_y": "暫不支援加密的組織匯出。",
  "txt_err_failed_to_clear_audit_logs": "清除稽核日誌失敗",
  "txt_err_failed_to_load_totp_status": "載入 TOTP 狀態失敗",
  "txt_err_failed_to_load_account_passkeys": "載入帳戶通行密鑰失敗",
  "txt_err_failed_to_load_audit_log_settings": "載入稽核日誌設定失敗",
  "txt_err_failed_to_load_audit_logs": "載入稽核日誌失敗",
  "txt_err_failed_to_load_invites": "載入邀請失敗",
  "txt_err_failed_to_load_profile": "載入資料失敗",
  "txt_err_failed_to_load_revision_date": "載入修訂日期失敗",
  "txt_err_failed_to_load_sends": "載入 Send 失敗",
  "txt_err_failed_to_load_users": "載入使用者失敗",
  "txt_err_failed_to_load_vault": "載入密碼庫失敗",
  "txt_err_failed_to_save_audit_log_settings": "儲存稽核日誌設定失敗",
  "txt_err_file_is_required": "檔案不能為空",
  "txt_err_file_password_is_required": "檔案密碼不能為空",
  "txt_err_folder_id_is_required": "資料夾 ID 不能為空",
  "txt_err_invalid_bitwarden_json": "無效的 Bitwarden JSON",
  "txt_err_invalid_keepass_xml_structure": "無效的 KeePass XML 結構",
  "txt_err_invalid_xml_file": "無效的 XML 檔案",
  "txt_err_invalid_attachment_download_response": "無效的附件下載回應",
  "txt_err_invalid_attachment_name": "無效的附件名稱",
  "txt_err_invalid_deletion_days": "無效的刪除天數",
  "txt_err_invalid_encrypted_file_data": "無效的加密檔案資料",
  "txt_err_invalid_expiration_days": "無效的到期天數",
  "txt_err_invalid_file_name": "無效的檔案名稱",
  "txt_err_invalid_max_access_count": "無效的最大存取次數",
  "txt_err_invalid_passkey_assertion_options": "無效的通行密鑰斷言選項",
  "txt_err_invalid_passkey_creation_options": "無效的通行密鑰建立選項",
  "txt_err_invalid_profile": "無效的資料",
  "txt_err_invalid_profile_key": "無效的資料金鑰",
  "txt_err_invalid_revision_date": "無效的修訂日期",
  "txt_err_mac_mismatch": "MAC 校驗不符",
  "txt_err_missing_mac_for_authenticated_cipher": "認證密文缺少 MAC",
  "txt_err_missing_file_url": "缺少檔案網址",
  "txt_err_missing_profile_key": "缺少資料金鑰",
  "txt_err_no_portable_backup_settings_wrap_is_available_fo": "目前管理員沒有可用的可攜備份設定封裝",
  "txt_err_offline_unlock_is_not_available_on_this_device": "此裝置不支援離線解鎖。",
  "txt_err_output_entropy_of_hash_function_is_too_small": "雜湊函式的輸出熵過小",
  "txt_err_permanent_delete_item_failed": "永久刪除項目失敗",
  "txt_err_revoke_invite_failed": "撤銷邀請失敗",
  "txt_err_send_key_unavailable": "Send 金鑰不可用",
  "txt_err_send_text_is_required": "Send 文字不能為空",
  "txt_err_unable_to_import_an_encrypted_proton_pass_export": "無法匯入加密的 Proton Pass 匯出檔案。",
  "txt_err_unable_to_import_an_encrypted_passky_backup": "無法匯入加密的 passky 備份。",
  "txt_err_unarchive_item_failed": "取消歸檔項目失敗",
  "txt_err_unauthorized": "未授權",
  "txt_err_unsupported_file_encryption_type": "不支援的檔案加密類型",
  "txt_err_update_folder_failed": "更新資料夾失敗",
  "txt_err_update_item_failed": "更新項目失敗",
  "txt_err_update_send_failed": "更新 Send 失敗",
  "txt_err_update_user_status_failed": "更新使用者狀態失敗",
  "txt_err_updating_file_content_is_not_supported_yet": "暫不支援更新檔案內容",
  "txt_err_vault_key_unavailable": "密碼庫金鑰不可用",
  "txt_err_invalid_encrypted_string": "無效的加密字串",
  "txt_err_prelogin_failed": "預登入失敗",
  "txt_err_unsupported_enc_type": "不支援的加密類型",
  "txt_err_import_exceeds_max": "匯入超過最大 {count} 筆限制",
  "txt_nodewarden_logo_alt": "NodeWarden 標誌",
  "txt_totp_qr_alt": "TOTP QR 碼",
  "nav_email_aliases": "電子郵件別名",
  "txt_alias_page_title": "電子郵件別名",
  "txt_alias_page_subtitle": "在你自己的網域上產生轉寄電子郵件別名，底層由 Cloudflare Email Routing 提供。",
  "txt_alias_disabled_notice": "本伺服器未啟用電子郵件別名產生器，請聯絡管理員啟用。",
  "txt_alias_disabled_admin": "電子郵件別名產生器已停用。請在下方設定中啟用並設定網域。",
  "txt_alias_domain": "網域",
  "txt_alias_format": "格式",
  "txt_alias_format_random_chars": "隨機字元",
  "txt_alias_format_random_words": "隨機單字",
  "txt_alias_format_uuid": "UUID",
  "txt_alias_destination": "轉寄至",
  "txt_alias_destination_default": "預設目標位址",
  "txt_alias_generate": "產生別名",
  "txt_alias_created_toast": "別名已建立",
  "txt_alias_created_copied": "別名已建立並複製到剪貼簿",
  "txt_alias_deleted_toast": "別名已刪除",
  "txt_alias_copied": "已複製到剪貼簿",
  "txt_alias_your_aliases": "你的別名",
  "txt_alias_none": "尚無別名。",
  "txt_alias_active": "已啟用",
  "txt_alias_inactive": "已停用",
  "txt_alias_enable": "啟用",
  "txt_alias_disable": "停用",
  "txt_alias_tokens_title": "API 存取權杖",
  "txt_alias_tokens_desc": "建立權杖以便在官方 Bitwarden 用戶端中使用別名產生器。",
  "txt_alias_token_name": "權杖名稱",
  "txt_alias_token_default_name": "API 權杖",
  "txt_alias_token_secret_notice": "請立即複製此權杖，它不會再次顯示。",
  "txt_alias_token_last_used": "上次使用 {date}",
  "txt_alias_token_never_used": "從未使用",
  "txt_alias_token_revoked_toast": "權杖已撤銷",
  "txt_alias_client_setup_title": "在官方 Bitwarden 用戶端中使用",
  "txt_alias_client_setup_desc": "在「轉寄電子郵件別名」產生器中選擇 addy.io 並填入以下內容：",
  "txt_alias_setup_step_service": "服務：addy.io",
  "txt_alias_setup_step_url": "自架伺服器網址：{url}",
  "txt_alias_setup_step_token": "API 存取權杖：上面建立的權杖",
  "txt_alias_setup_step_domain": "網域：已設定的別名網域之一",
  "txt_alias_settings_title": "產生器設定",
  "txt_alias_settings_cf_configured": "已設定 Cloudflare API 憑證；可使用自訂轉寄目標並停用別名。",
  "txt_alias_settings_cf_missing": "未設定 Cloudflare API 憑證。Catch-all 別名可用；自訂目標與停用需要 CF_API_TOKEN 與 CF_ZONE_ID。",
  "txt_alias_settings_enabled": "啟用別名產生器",
  "txt_alias_settings_domains": "別名網域",
  "txt_alias_settings_domains_help": "每行一個網域，且必須已啟用 Cloudflare Email Routing。",
  "txt_alias_settings_default_domain": "預設網域",
  "txt_alias_settings_default_destination": "預設轉寄目標位址",
  "txt_alias_settings_recipients": "允許的目標位址",
  "txt_alias_settings_recipients_help": "每行一個電子郵件，可作為進階轉寄目標供選擇。",
  "txt_alias_settings_saved_toast": "別名設定已儲存",
  "txt_alias_load_failed": "載入別名失敗",
  "txt_alias_create_failed": "建立別名失敗",
  "txt_alias_update_failed": "更新別名失敗",
  "txt_alias_delete_failed": "刪除別名失敗",
  "txt_alias_token_load_failed": "載入權杖失敗",
  "txt_alias_token_create_failed": "建立權杖失敗",
  "txt_alias_token_delete_failed": "撤銷權杖失敗",
  "txt_alias_settings_load_failed": "載入別名設定失敗",
  "txt_alias_settings_save_failed": "儲存別名設定失敗",
};
