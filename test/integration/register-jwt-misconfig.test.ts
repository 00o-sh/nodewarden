...
// handleRegister refuses to run when JWT_SECRET is missing or too short. The
// REAL handler is invoked against an env whose JWT_SECRET genuinely has each
// unsafe value, so jwtSecretUnsafeReason takes its real branches (400). No mocks.
